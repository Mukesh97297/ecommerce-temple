...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Makemywebsite.com</title>
        <meta name="descriptions" content="Makemywebsite.com" />
        <link rel="stylesheet" href="/favicon.ico" />
      </Head>
     
      <div>
        <Image src="/home.jpg" alt="" width={1500} height={500} />
      </div>
      <div>
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
              <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Makemywebsite.com.au</h1>
              <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">A promising agency that redefines digitalisation and develops magnificent web experiences</p>
            </div>
